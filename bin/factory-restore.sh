...
This script will:
-restore your phone to 5.5.893 from the fastboot VZW Files
 (VRZ_XT875_5.5.893.XT875.Verizon.en.US_CFC_01.xml.zip)

IT ERASES EVERYTHING EXCEPT FOR THE SDCARD!!! THIS INCLUDES 
THE INTERNAL SDCARD (usually mounted at /sdcard)!!!!
...
_EOF
read -n1 -p "Press Enter to continue (ctrl-c now to quit)"

# warning
cat <<_EOF

              THIS WILL WIPE YOUR PHONE
It then restores from the Offical 5.5.893 images and wipes ALL your data
...
my_fastboot reboot-bootloader
my_fastboot flash cdt.bin cdt.bin
